        ...
        <div className='col-xs-12 col-sm-9 col-md-7 mt-5 px-1'>
          <form className='col-lg-12 bg-white mx-auto mt-5' onSubmit={handleSubmit}>
            ...
            <div className='col-xs-12'>
              <BtnSubmit title='Log in' classes='btn rounded-0 btn-outline-success' />
            </div>
            <div className='col-xs-12'>
              <BtnLink to='/register' title='Click here to register' classes='rounded-0 btn btn-primary btn-lg btn-block' />
            </div>
          </form>
        </div>
      </div>
